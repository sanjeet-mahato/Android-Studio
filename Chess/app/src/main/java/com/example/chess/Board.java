...
public class Board {
    ...
    Board()//Non-parameterized constructor to create a board object
    {
        for (int i = 0; i < 32; i++) {
            piece[i] = 0;
            designation[i] = i;
    ...
    Board minimax(int choice, int depth, double alpha, double beta) {//method using minimax algorithm with alpha beta pruning to find the best move for a player given a chess board state
        Board obj = this;
        Board b = null;
        Board min = null;
